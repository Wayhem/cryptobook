...
import { ResourcesAction, fetchSuccessResource, resetResource } from 'Store/actions/resourceActions'
...
describe('Testing resource reducer', () => {
  ...
  test('should handle fetching resource data on success', () => {
    expect(resourcesReducer(initialState, fetchSuccessResource(Entities.ORDER_BOOK, orderBookMock))).toEqual({
      ...initialState,
